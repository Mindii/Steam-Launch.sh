...
That's it, now just lookup foldername for the game and add commands that you like for it, you can even fix problems that you would need to fix manually on every launch (for example lookup mafia III entry line 74).
